...
string FindCode(string pKeypadToUse, char pStartingChar, string pInstructions)
{
    ...
    string[] instructionLines = pInstructions.Split("\r\n", StringSplitOptions.RemoveEmptyEntries);

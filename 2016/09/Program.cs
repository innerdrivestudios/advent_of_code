...
//For part 2, the decompression is not allowed to skip decompressed parts.... so...
//To calculate the decompressed length of X(8x2)(3x3)ABCY we...
//1. Count X (=1)
//2. Now we encounted (8x2), so we need to calculate 2 * the decompressed length of (3x3)ABC + the length of everything after it (which is Y)

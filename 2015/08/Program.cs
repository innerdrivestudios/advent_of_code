...
//Your input: a task of weirdly formatted/escaped strings
...
//Your task: to unescape/escape the given strings and count the changes in the amount of chars used to express the strings

Part1_UnescapeDifferences(myInput);
Part2_EscapeDifferences(myInput);
Console.ReadKey();
